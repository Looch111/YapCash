...
class SupabaseClient {
  ...
  async refreshSession() {
    ...
    // Auto-persist rotated Supabase tokens back to accountManager & disk
    try {
      const { updateAccountTokens } = require("./accountManager");
      updateAccountTokens(this.account.accountId, {
