...
async function handleCallbackQuery(callbackQuery) {
  ...
  if (cbData === "show_status") {
    ...
    const lines = [
      `<b>📊 YAPCASH SYSTEM OVERVIEW (14 ACCOUNTS)</b>`,
    ...
    lines.push(`────────────────────────`);
    lines.push(`💎 <b>Total XP:</b> <code>${totalSystemXp.toLocaleString()} XP</code> │ 🌐 <b>Proxies:</b> <code>${activeProxiesCount}/14 Live</code>`);
