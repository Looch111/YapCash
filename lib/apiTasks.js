 ...
 * 1. Streak Auto-Healing Reconciliation
 * 2. Daily Bonus
        * 3. Daily Spin
 * 4. Weekly Calendar Bonus
 * 5. Recover Unclaimed Gift Cards
 * 6. Farm XP until 500 XP daily cap reached
 */
async function runFullDailyRoutine(client, options = {}) {
  ...
  // 5. Recover Unclaimed Gift Cards
  summary.recoveredCards = await recoverUnclaimedGiftCards(client);

  // 6. Farm XP until 500 XP daily cap is reached (or custom amount if passed)
